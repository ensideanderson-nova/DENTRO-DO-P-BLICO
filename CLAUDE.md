...
```
Observações:
- Mantenha os comandos shell exatamente como no exemplo ao executar; as explicações e instruções estão em português.
- Teste sempre com `--dry-run` antes de aplicar as mudanças de fato.
